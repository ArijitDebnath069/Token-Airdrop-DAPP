      ...
      <main className="relative z-10 flex flex-1 w-full max-w-5xl mx-auto flex-col items-center px-6 pt-10 pb-16">
        ...
        <div className="mb-10 text-center animate-fade-in-up">
          ...
          <h1 className="mb-3">
            <span className="block text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">
              <span className="text-white">Token Airdrop </span>
              <span className="bg-gradient-to-r from-[#7c6cf0] via-[#f472b6] to-[#4fc3f7] bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
                Tool
              </span>
            </span>
          </h1>
          ...
          <p className="mx-auto max-w-lg text-sm sm:text-base leading-relaxed text-white/40">
            Send tokens to multiple wallets in one transaction — equal amounts or fully customized. Permissionless, trustless, on-chain.
          </p>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 animate-fade-in">
          ...
          <div className="flex items-center gap-3 text-xs text-white/20">
            {[
              { label: "Connect Wallet", color: "bg-[#7c6cf0]/50" },
              { label: "Enter Token + Recipients", color: "bg-[#f472b6]/50" },
              { label: "Send Airdrop", color: "bg-[#4fc3f7]/50" },
            ].map((step, i) => (
